...
选择第一个责任人="//div[4]//ul[@role='listbox']/li[1]"
确认按钮="//span[text()='确 定']/.."
...
绿化植被选择第一个管理区="//div[3]//ul[@role='listbox']/li[1]"
...
绿化植被第一个区域="//div[4]//ul[@role='listbox']/li[1]"
...
绿化事件选择第一个管理区="//div[3]//ul[@role='listbox']/li[1]"
绿化事件名称输入框="//input[@id='name']"
绿化事件类型下拉="//div[@id='greeningMaintenanceTypeId']//div"
绿化事件第一个类型="//div[4]//ul[@role='listbox']/li[1]"
绿化事件区域下拉="//div[@id='greeningAreaId']//div"
绿化事件第一个区域="//div[5]//ul[@role='listbox']/li[1]"
绿化事件负责人="//div[@id='staffId']/div"
绿化事件第一个负责人="//div[6]//ul[@role='listbox']/li[1]"
...
绿化工作检查结果="//div[8]//ul[@role='listbox']/li[1]"
绿化植被新建确定="//span[text()='确 定']/.."


#通用
搜索框="//input[@placeholder='搜索...']"
搜索="//input[@placeholder='搜索...']/..//svg"
