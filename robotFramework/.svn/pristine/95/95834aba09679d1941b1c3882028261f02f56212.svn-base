...
欠费按时长分阶统计_费用时段_开始="//div[@class='ant-calendar-range-part ant-calendar-range-left']//tr[1]/td[1]"
欠费按时长分阶统计_费用时段_结束="//div[@class='ant-calendar-range-part ant-calendar-range-right']//tr[last()]/td[last()]"
...
欠费按时长分阶统计_楼宇停车场="//div[@id='organizationItemIds']"
欠费按时长分阶统计_选择楼宇停车场="//body/div[5]//ul/li[1]"
欠费按时长分阶统计_搜索="//form/div[1]//div/button[1]"
欠费按时长分阶统计_重置="//form/div[1]//div/button[2]"
欠费按时长分阶统计_导出="//form/parent::div/preceding-sibling::div/button"
欠费按时长分阶统计_表格="//table"
##########欠费按金额分阶统计##########
