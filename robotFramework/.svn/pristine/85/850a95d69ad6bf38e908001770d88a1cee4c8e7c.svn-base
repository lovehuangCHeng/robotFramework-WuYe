...
应收年度统计_跳转页面title验证="//div[@class='page-bar']/ul/li[2]"
...
欠费年度统计_跳转页面title验证="//div[@class='page-bar']/ul/li[2]"
...
已收费用年度统计_跳转页面title验证="//div[@class='page-bar']/ul/li[2]"
...
收费率年度统计_跳转页面title验证="//div[@class='page-bar']/ul/li[2]"
