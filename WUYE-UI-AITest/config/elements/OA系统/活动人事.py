...
活动类别保存="//body/div[7]//div[@class='ant-modal-content']/div[3]//button[2]"
...
###排班设置###
排班新建="//div[@class='ant-tabs ant-tabs-top ant-tabs-line']//div[@role='tabpanel'and @aria-hidden='false']//button/span[text()='新 建']"
班次名称="id=className"
...
班组员工="//span/ul"
班组员工数据="//div[@id='rc-tree-select-list_3']/ul/li[last()]/span[2]"
