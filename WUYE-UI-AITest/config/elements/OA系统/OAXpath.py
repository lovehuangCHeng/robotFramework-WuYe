...
编辑文档类别按钮="//div/button[@class='ant-btn ant-btn-primary'][1]"
删除文档类别按钮="//div/button[@class='ant-btn ant-btn-primary'][2]"
文档类别复选框="//tr[1]//span/label//input[@class='ant-checkbox-input']"
...
编辑会议类别按钮="//div/button[@class='ant-btn ant-btn-primary'][1]"
删除会议类别按钮="//div/button[@class='ant-btn ant-btn-primary'][2]"
会议类别复选框="//tr[1]//span/label//input[@class='ant-checkbox-input']"
...
编辑文档资料="//div[@class='ant-table-fixed-right']//tbody/tr[1]/td/span/a[text()='编辑']"
