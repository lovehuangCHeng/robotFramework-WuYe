...
选择操作时间今天="//span[@id='createDate']//div[@class='ant-calendar-footer-extra ant-calendar-range-quick-selector']/div[1]"
...
#组织架构
组织架构新建按钮="//button[@class='btn btn-primary dropdown-toggle']"
新建分公司按钮="//a[@id='createCompany']"
新建部门按钮="//a[@id='createDepartment']"
上级部门下拉框="//span[@class='select2-selection select2-selection--single']"
选择上级部门="//ul[@id='select2-ParentId-results']/li[1]"
...
新建分公司部门保存按钮="//button[@id='btnSave']"
组织架构简单搜索输入框="//input[@id='searchTerm']"
组织架构简单搜索按钮="//button[@id='btnFilter']"
一条组织架构数据="//*[@id='gridCompany']//tbody/tr[1]/td[3]"
编辑组织架构按钮="//button[@id='btnEdit']"
删除组织架构按钮="//button[@id='btnDelete']"
确认删除组织架构按钮="//a[@class='btn btn-sm btn-danger']"
#权限管理
新建权限按钮="//button[@id='btnAdd']"
编辑权限按钮="//button[@id='btnEdit']"
...
新建编辑权限保存按钮="//button[@id='btnSave']"
简单搜索权限输入框="//input[@id='searchTerm']"
简单搜索权限按钮="//button[@id='btnFilter']"
一条权限数据="//tbody/tr[1]/td[1]"
删除权限按钮="//button[@id='btnDelete']"
确认删除权限按钮="//a[@class='btn btn-sm btn-danger']"
#用户列表
新建用户按钮="//button[@id='btnAdd']"
编辑用户按钮="//button[@id='btnEdit']"
用户名称输入框="//input[@id='Name']"
用户电话输入框="//input[@id='Tel']"
新建编辑用户保存按钮="//button[@id='btnSave']"
简单搜索用户输入框="//input[@id='searchTerm']"
简单搜索用户按钮="//button[@id='btnFilter']"
高级搜索展开框="//button[@class='btn filter-collapse-toggle']"
用户高级搜索按钮="//button[@id='btnFilterDetail']"
一条用户数据="//tbody/tr[1]/td[1]"
显示下拉框="//button[@id='btnEnable']/following-sibling::div[1]/button"
显示启用="//a[@id='showEnable']"
显示禁用="//a[@id='showDisable']"
禁用用户按钮="//button[@id='btnDisable']"
启用用户按钮="//button[@id='btnEnable']"
删除用户按钮="//button[@id='btnDelete']"
确认删除用户按钮="//a[@class='btn btn-sm btn-danger']"
导入用户下拉框="//button[@id='btnEnable']/following-sibling::div[2]/button"
下载导入用户模板="//div[@class='col-md-8 col-sm-12 col-xs-12 toolbar']/div[2]/ul/li[1]/a"
职员组织机构Tab="//ul[@class='nav nav-tabs']/li[2]/a"
职员岗位Tab="//ul[@class='nav nav-tabs']/li[3]/a"
职员组织机构_选择左侧组织架构="//*[@id='organizationTreeList']//tbody/tr[1]/td[1]"
职员岗位_选择左侧组织架构="//*[@id='roleGrid']/div[2]//tbody/tr[1]/td"
选择职员按钮="//button[@id='selectStaff']"
选择一个职员添加="//tbody/tr[1]"
添加员工保存按钮="//button[@id='btnSave']"
选择一个职员移除="//*[@id='memberGrid']/div[2]/table/tbody/tr[1]"
移除职员按钮="//button[@id='btnRemove']"
